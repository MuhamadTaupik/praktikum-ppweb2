...
<body>
    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="" method="GET">
            ...
            <div class="form-group row">
                <label for="nilai_uas" placeholder="Nilai UAS" class="col-5 col-form-label font-weight-bold text-right">Nilai UAS</label>
                <div class="col-7">
    ...
    <?php
    $proses = isset($_GET['proses']) ? $_GET['proses'] : 'kososng';
